...
Class T9ABooks {
    ...
    static T9ABooks() {
		...
		[T9ABooks]::scrolls.sSE = New-Object T9ABook -Property  @{
            BookId        = "sSE"
            FilebaseId    = 0
            ErrorReportId = 0
            TexDirName    = "Scrolls/Scrolls_Sylvan_Elves/"
        }
        ...
        [T9ABooks]::collections.Scrolls = [T9ABooks]::scrolls
        [T9ABooks]::collections.All = [T9ABooks]::coreRules + [T9ABooks]::supplements + [T9ABooks]::scrolls
    }
}
...
Function Get-Books {
    ...
    Process {
		...
		if ($BookIds.Contains("SCROLLS")) {
            $parsedBookIds += [T9ABooks]::collections.Scrolls.Keys
        }
        
        $parsedBookIds += $BookIds | Where-Object { -NOT(($_ -EQ "ALL") -OR ($_ -EQ "CORERULES") -OR ($_ -EQ "SCROLLS") -OR ($_ -EQ "SUPPLEMENTS")) }
